...
function DetailCard() {
  return (
    <div className="min-h-screen font-montserrat relative">
      ...
      >
        <div className="text-3xl font-bold">Karya Tulis Ilmiah BUTTMKP</div>
      </div>
              ...
              <div className="text-center">
                ...
                <div className="py-4 space-y-4">
                  ...
                  <div className="text-sm w-5/6 mx-auto">
                    ...
                    Quod quo reiciendis earum unde quisquam ex error tenetur
                    culpa maxime voluptate.
                  </div>
                  <button className="bg-green-primary hover:bg-green-600 px-7 py-2 rounded-full text-white font-semibold">
                    Baca Karya Tulis
                  </button>
                </div>
              </div>
