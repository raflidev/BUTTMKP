    ...
    <div className='min-h-screen font-montserrat relative'>
      ...
      <div className="px-20 relative z-10 py-20 bg-white">
            ...
            data.map((item, index) => {
              return (
                <div key={index} className=''>
                  <button onClick={() => setActive(item.id-1)} className={`${data[active].nama === item.nama ? 'text-green-primary bg-green-100 border border-b-green-primary' : 'text-gray-400 border border-b-gray-400' }  hover:bg-green-100 hover:text-green-primary  px-3 py-3 font-bold  border-transparent`}>
                    Visi & Misi {item.nama}
                  </button>
                </div>
              )
        ...
        <div className='space-y-10'>
          <div>
            <h1 className='font-bold text-2xl text-green-primary'>Visi {data[active].nama} </h1>
            <p className='mt-3 font-medium text-lg'>
            {data[active].visi}
            </p>
          </div>
          <div className='space-y-4'>
            <h1 className='font-bold text-2xl text-green-primary'>Misi {data[active].nama}  </h1>
                    ...
                    return (
                      <div className='flex space-x-4' key={index}>
                        <div className="flex justify-center items-center bg-yellow-400 h-[5rem] w-[5rem] rounded-lg">
                          <div className='font-bold text-4xl text-black'>{item.id}</div>
                        </div>
